...
public class DataSeeder {
    ...
    CommandLineRunner commandLineRunner(TextRepository textRepository,
        ...
        return args -> {
            ...
            log1.setEntityName(word1.getWord());
            ...
            log2.setEntityName(word2.getWord());
            ...
            log3.setEntityName(word3.getWord());
            ...
            log4.setEntityName(word4.getWord());
            ...
            log5.setEntityName(word5.getWord());
            ...
            log6.setEntityName(text1.getTitle());
            ...
            log7.setEntityName(text2.getTitle());
            ...
            log8.setEntityName(text3.getTitle());
            ...
            log9.setEntityName(text4.getTitle());
            ...
            log10.setEntityName(text5.getTitle());
